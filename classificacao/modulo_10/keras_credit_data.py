...
#base = pd.read_csv('D:\código\python\machine_learning\classificacao\modulo_3\credito.csv')
base = pd.read_csv('/media/igor/Documentos/código/python/machine_learning/classificacao/modulo_3/credito.csv')
